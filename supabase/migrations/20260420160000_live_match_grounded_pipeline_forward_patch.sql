...
-- ============================================================
-- Forward patch for the live match grounded pipeline.
-- Replays the current idempotent schema/function/view definitions
-- onto remote projects that already consumed an older
-- 20260420113000 migration body.
-- ============================================================
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      ...
      AND policyname = 'Public read match events'
  ) THEN
