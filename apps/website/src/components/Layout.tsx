      ...
      {isHome && (
        ...
        >
          ...
          {walletNavigationItem && (
            <NavLink to={walletNavigationItem.to} className="bg-surface_container_lowest hover:bg-surface2 transition-colors px-3 py-1.5 rounded-full border border-border flex items-center gap-2 shadow-sm">
