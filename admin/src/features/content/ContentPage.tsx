...
export function ContentPage() {
  ...
  const {
    ...
    error,
    refetch,
  } = useBanners({ page }, { search, placement: placementFilter });
  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Manage promotional banners and notices"
        actions={
          <UnavailableActionButton
            icon={<Plus size={16} />}
            label="Add Banner"
            title="Banner creation is not live in this build."
          />
        }
      />
      ...
      <div className="grid grid-4 gap-4 mb-6">
        <KpiCard
          label="Total Banners"
          value={result?.count ?? banners.length}
          icon={<Image size={18} />}
        />
        <KpiCard
          label="Active"
        ...
        <KpiCard
          label="Placements"
          value={[...new Set(banners.map((b) => b.placement))].length}
          icon={<Globe size={18} />}
        />
        <KpiCard
          label="Expired"
          value={
            banners.filter(
              (b) => b.valid_until && new Date(b.valid_until) < new Date(),
            ).length
          }
              ...
              {banners.map((b) => (
                ...
                >
                  ...
                  <td className="text-muted">
                    {b.valid_until ? formatDate(b.valid_until) : "—"}
                  </td>
                  <td>
          ...
          <>
            <DrawerSection title="Banner Info">
              ...
              <DrawerField
                ...
                value={
                  <span className="badge badge-neutral">
                    {selected.placement.replace(/_/g, " ")}
                  </span>
                }
              />
              ...
              <DrawerField
                ...
                value={
                  selected.action_url ? (
                    <a href={selected.action_url} className="text-primary">
                      {selected.action_url}
                    </a>
                  ) : (
                    "—"
