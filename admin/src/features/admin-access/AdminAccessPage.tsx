  ...
  return (
    <div>
      ...
      <div className="grid grid-4 gap-4 mb-6">
        ...
        <KpiCard
          label="Inactive"
          value={admins.length - activeCount}
          icon={<UserX size={18} />}
        />
        <KpiCard
          label="Roles"
          value={[...new Set(admins.map((a) => a.role))].length}
          icon={<Shield size={18} />}
        />
      </div>
          ...
          <div className="flex gap-4 items-end">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                disabled={!invitePhone.trim() || inviteMutation.isPending}
              >
      ...
      <div className="card mb-6 p-5">
        ...
        <div className="grid grid-4 gap-3">
          {[
            ...
            {
              role: "Viewer",
              desc: "Read-only access to dashboard and analytics. No write operations.",
              color: "var(--fz-muted)",
            },
          ].map((r) => (
            <div
                ...
                <tr key={a.id}>
                  ...
                  <td>
                    <select
                      ...
                      value={a.role}
                      onChange={(e) =>
                        handleRoleChange(a, e.target.value as AdminRole)
                      }
                      disabled={
                        a.role === "super_admin" || changeRoleMutation.isPending
                      }
                    >
                      <option value="viewer">Viewer</option>
                      <option value="moderator">Moderator</option>
