import { Coins, Shield, RefreshCw, TrendingUp, Lock, Gift, ArrowRight } from 'lucide-react';
    ...
    <div>
      ...
      <section className="section container">
        <div className="grid grid-cols-3 gap-6" style={{ maxWidth: 1000, margin: '0 auto' }}>
          ...
          <div className="glass-card fade-in-up fade-in-up-delay-1" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <p className="text-secondary text-sm" style={{ lineHeight: 1.7 }}>
              Supply is capped at 100,000,000 FET. All minting is enforced by audited RPCs with Row-Level Security. No tokens can be created outside approved paths and every transaction is recorded immutably.
            </p>
          </div>

          <div className="glass-card fade-in-up fade-in-up-delay-2" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <section className="section" style={{ background: 'var(--fz-surface)' }}>
        <div className="container" style={{ maxWidth: 900, margin: '0 auto' }}>
          <div className="section-header">
            ...
            <p>Multiple paths to grow your balance — all based on skill and engagement, never money.</p>
          </div>
      ...
      <section className="section container">
        <div className="glass-card-static fade-in-up" style={{
          ...
          <p className="text-secondary mb-4" style={{ lineHeight: 1.7, maxWidth: 600, margin: '0 auto 16px' }}>
            FANZONE is a <strong style={{ color: 'var(--fz-text)' }}>free-to-play prediction platform</strong>. FET tokens are an internal engagement currency with <strong style={{ color: 'var(--fz-text)' }}>no fiat monetary value</strong>. Tokens cannot be purchased with real money and do not constitute gambling.
          </p>
          <p className="text-secondary text-sm" style={{ lineHeight: 1.7, maxWidth: 600, margin: '0 auto 24px' }}>
            Rewards are granted as promotional discounts through partner agreements. The total supply of FET is hard-capped at 100,000,000 tokens and enforced at the database level.
          </p>
          <div className="flex gap-4 justify-center">
            <Link to="/rewards" className="btn btn-outline">Partner Rewards <ArrowRight size={16} /></Link>
            <Link to="/terms" className="btn btn-ghost">Read Terms</Link>
          </div>
        </div>
      </section>
    </div>
