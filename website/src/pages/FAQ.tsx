...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Yes. Navigate to Settings → Request Account Deletion in the app. Your personal data is deleted within 30 days. Anonymized prediction and leaderboard data may be retained for statistical purposes. You can also email privacy@ikanisa.com to exercise your GDPR rights.',
  },
  {
  ...
  return (
    <div>
      ...
      <section className="section container">
        <div style={{ maxWidth: 800, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '8px' }}>
          {FAQS.map((faq, i) => (
            <div
              key={i}
