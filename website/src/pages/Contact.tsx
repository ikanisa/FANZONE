  ...
  return (
    <div>
      <div className="page-heading container">
        ...
        <p>
          Questions about predictions, your wallet, account security, or partner
          rewards? We're here to help.
        </p>
      </div>
        ...
        >
          ...
          >
            ...
            <p
              ...
              style={{ lineHeight: 1.6, maxWidth: 280 }}
            >
              {renderFanzoneText(
          ...
          >
            ...
            <p
              ...
              style={{ lineHeight: 1.6, maxWidth: 280 }}
            >
              For partnerships, data requests, account deletion, GDPR inquiries,
              or detailed technical issues.
            </p>
            <div className="flex items-center gap-2 text-xs text-muted">
              <Clock size={12} />
          ...
          >
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                <div className="text-sm text-secondary">
                  GDPR rights, data export, account deletion
                </div>
              </div>
              <a
                href="mailto:info@ikanisa.com"
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                <div className="text-sm text-secondary">
                  Partnerships, press, and general inquiries
                </div>
              </div>
              <a
                href="mailto:info@ikanisa.com"
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                <div className="text-sm text-secondary">
                  Use Settings → Request Account Deletion in the app, or email
                  us
                </div>
              </div>
              <a
