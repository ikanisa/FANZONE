  ...
  return (
    <div>
      <div className="page-heading container">
        ...
        <p>
          We intentionally limit our scope to the top-flight leagues and global
          competitions that matter most to real fans.
        </p>
      </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span
                    ...
                    style={{
                      color:
                        league.tier === "Top Flight"
                          ? "var(--fz-accent)"
                          : league.tier === "Continental"
                            ? "var(--fz-coral)"
                            : "var(--fz-success)",
                      fontWeight: 600,
                    }}
        ...
        <div className="container" style={{ maxWidth: 900, margin: "0 auto" }}>
          <div className="grid grid-cols-2 gap-8">
            ...
            >
              <div
                className="icon-box"
                style={{ background: "rgba(15, 123, 108, 0.15)" }}
              >
