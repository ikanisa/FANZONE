  ...
  return (
    <div>
      <div className="page-heading container">
        ...
        <p>
          Convert your football knowledge into real-world value through our
          exclusive Maltese and global partner network.
        </p>
      </div>
        ...
        >
          ...
          >
            ...
            <p className="text-secondary text-sm" style={{ lineHeight: 1.7 }}>
              Climb leaderboards, ace daily challenges, and grow your token
              balance transparently through verified predictions and community
              engagement.
            </p>
          </div>
          ...
          >
            ...
            <p className="text-secondary text-sm" style={{ lineHeight: 1.7 }}>
              Use your FET tokens to claim partner rewards directly in the app.
              Redemptions are processed securely through the audited FET ledger
      ...
      <section className="section" style={{ background: "var(--fz-surface)" }}>
        <div className="container" style={{ maxWidth: 800, margin: "0 auto" }}>
          <div className="section-header">
            ...
            <p>
              {renderFanzoneText(
                "The FANZONE partner marketplace is expanding. Here's what to expect.",
              )}
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Exclusive percentage-off deals at select retail and partner locations worldwide.",
              },
              {
                title: "Merchandise",
                desc: "Football-related merchandise and branded items available for FET redemption.",
              },
              {
                title: "F&B Offers",
                desc: "Restaurant and café partner deals for match-day dining and fan meetups.",
              },
              {
                title: "Digital Products",
                desc: "Digital vouchers, subscriptions, and premium content access from partner brands.",
              },
            ].map((item, i) => (
              <div
                key={i}
      ...
      <section className="section container">
        ...
        >
          <div
            className="icon-box"
            style={{ background: "rgba(152, 255, 152, 0.1)", flexShrink: 0 }}
          >
          ...
          <div>
            ...
            <p className="text-secondary text-sm" style={{ lineHeight: 1.7 }}>
              All FET redemptions are processed through the audited ledger with
              Row-Level Security. Transactions are fully transparent, immutable,
              and reconcilable by operators. Partner rewards are fulfilled as
              promotional discounts — FET tokens have no fiat monetary value and
