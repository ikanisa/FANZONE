  ...
  return (
    <div className="section container">
      <div className="legal-content fade-in-up">
        <h1 style={{ fontSize: '2.25rem', fontWeight: 800, marginBottom: '8px' }}>Terms and Conditions</h1>
        ...
        <p>
          FANZONE is a <strong>free-to-play prediction platform</strong>. Our internal ledger token (FET — Fan Engagement Token) possesses no fiat monetary value, cannot be purchased with real money, and does not constitute real-money gambling.
        </p>
        <p>
          FET tokens are earned exclusively through platform engagement (predictions, challenges, community participation) and may be redeemed for promotional discounts and rewards at partner locations. No real money is wagered, deposited, or withdrawn at any point.
        </p>
        ...
        <ul>
          ...
          <li>You will not create accounts for others or share your account credentials</li>
          <li>Guest browsing is available without registration for limited read-only access</li>
        </ul>

        <h2>6. FET Token Economy</h2>
        <p>The FET (Fan Engagement Token) system is governed by the following rules:</p>
        <ul>
          <li>FET tokens have no fiat monetary value and cannot be sold, traded, or exchanged for real currency</li>
          <li>Total FET supply is capped at 100,000,000 tokens, enforced at the database level</li>
          <li>FET can be earned through predictions, daily challenges, and welcome grants</li>
          <li>FET can be redeemed for promotional offers at partner locations</li>
          ...
          <li>IKANISA reserves the right to adjust tokenomics, earning rates, and redemption terms</li>
        </ul>
        ...
        <ul>
          ...
          <li>Attempt to manipulate prediction challenges, pools, or community meters</li>
          <li>Exploit bugs or vulnerabilities in the platform</li>
          <li>Post or share content that is illegal, harmful, or offensive</li>
        </ul>
        <p>
          Violations will result in immediate account termination and forfeiture of all FET balance.
        </p>
        ...
        <p>
          Football match data, team names, competition names, and related trademarks belong to their respective owners and are used under fair use for fan engagement purposes.
        </p>

        <h2>9. Privacy</h2>
        <p>
          Your use of FANZONE is also governed by our <a href="/privacy" style={{ color: 'var(--fz-accent)', textDecoration: 'underline', textUnderlineOffset: '2px' }}>Privacy Policy</a>, which details how we collect, use, and protect your information.
        </p>
        ...
        <p>
          We reserve the right to modify, suspend, or discontinue any aspect of the App — including tokens, leaderboards, prediction mechanics, partner offers, or redeemable products — at any time without prior notice.
        </p>
        ...
        <ul>
          <li><strong>Email:</strong> info@ikanisa.com</li>
          <li><strong>Privacy inquiries:</strong> privacy@ikanisa.com</li>
