        ...
        {activeTab === 'Members' && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
            ...
            <div className="space-y-2">
              <MemberRow rank={1} fanId="#102 948" tier="Legend" fet="12.4k" />
              <MemberRow rank={2} fanId="#483 291" tier="Ultra" fet="8.2k" isMe />
              <MemberRow rank={3} fanId="#992 110" tier="Ultra" fet="7.1k" />
              <MemberRow rank={4} fanId="#331 002" tier="Member" fet="4.5k" />
              <MemberRow rank={5} fanId="#884 122" tier="Member" fet="3.1k" />
            </div>
          </motion.div>
        )}
