...
import { FanzoneWordmark, renderFanzoneText } from "./FanzoneWordmark";
    ...
    >
      ...
      <div className="container" style={{ padding: "48px 24px 40px" }}>
        ...
        >
          ...
          >
            ...
            >
              Football predictions, fan communities & rewards. The ultimate
              platform for football fans.
            </p>
            <p
              style={{
          ...
          >
            ...
            <Link
              to="/overview"
              style={{ color: "var(--fz-muted)", fontSize: "0.8125rem" }}
            >
              How it Works
            </Link>
            <Link
      ...
      >
        <p style={{ color: "var(--fz-muted-2)", fontSize: "0.75rem" }}>
          © {currentYear} {renderFanzoneText("FANZONE. All rights reserved.")}
        </p>
        <p style={{ color: "var(--fz-muted-2)", fontSize: "0.75rem" }}>
          A product of{" "}
          <a
            href="https://ikanisa.com"
            target="_blank"
            rel="noreferrer"
            style={{
              color: "var(--fz-muted)",
